...
class AnnotatedDocumentWindow(QWidget):
    ...
    def run_narrative_bias_highlight(self, article_text):
        ...
        prompt = (
            ...
            "Then, for each highlighted phrase, write a paragraph explanation in this format:\n"
            "<b>[Phrase]</b>: explanation of why it's an example of narrative bias.\n"
            "Separate each explanation with a single newline.\n\n"
            "Return ONLY the full HTML including the article and the explanations — no extra text.\n\n"
            "Article:\n" + article_text
        )
    ...
    def run_sentiment_bias_highlight(self, article_text):
        ...
        prompt = (
            ...
            "After the full article, add **two blank lines**.\n"
            "Then, for each highlighted phrase, write a paragraph explanation in this format:\n"
            "<b>[Phrase]</b>: explanation of why it's an example of sentiment bias.\n"
            "Separate each explanation with a single newline.\n\n"
            "Return ONLY the full HTML including the article and the explanations — no extra text.\n\n"
            "Article:\n" + article_text
        )
    ...
    def run_regional_bias_highlight(self, article_text):
        ...
        prompt = (
            ...
            "After the full article, add **two blank lines**.\n"
            "Then, for each highlighted phrase, write a paragraph explanation in this format:\n"
            "<b>[Phrase]</b>: explanation of why it's an example of regional bias.\n"
            "Separate each explanation with a single newline.\n\n"
            "Return ONLY the full HTML including the article and the explanations — no extra text.\n\n"
            "Article:\n" + article_text
        )
    ...
    def run_slant_highlight(self, article_text):
        ...
        prompt = (
            ...
            "After the full article, add **two blank lines**.\n"
            "Then, for each highlighted phrase, write a paragraph explanation in this format:\n"
            "<b>[Phrase]</b>: explanation of why it's an example of slant.\n"
            "Separate each explanation with a single newline.\n\n"
            "Return ONLY the full HTML including the article and the explanations — no extra text.\n\n"
            "Article:\n" + article_text
        )
    ...
    def run_coverage_depth_highlight(self, article_text):
        ...
        prompt = (
            ...
            "After the full article, add **two blank lines**.\n"
            "Then, for each highlighted phrase, write a paragraph explanation in this format:\n"
            "<b>[Phrase]</b>: explanation of why it's an example of coverage depth.\n"
            "Separate each explanation with a single newline.\n\n"
            "Return ONLY the full HTML including the article and the explanations — no extra text.\n\n"
            "Article:\n" + article_text
        )
    ...
    def summarize_explanations(self):
        ...
        prompt = (
            "You are given text with explanations for bias phrases. "
            "Format the output as a Python-style list of dictionaries, where each dictionary has the phrase as the key and explanation as the value, like this:\n"
            "[\n"
            '  {"phrase1": "explanation1"},\n'
            '  {"phrase2": "explanation2"}\n'
            "]\n"
            "Input:\n" + explanation_text + "\n"
            "Return ONLY the formatted list, no extra text."
        )
        ...
        self.explanation_summary_box.setPlainText(formatted_output)
